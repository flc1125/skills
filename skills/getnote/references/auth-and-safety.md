...
Use this file when preparing or executing a Getnote request.
...
- execute a live Getnote API call with clear user intent
- upload a local image to Getnote OSS for an image-note workflow
- poll a Getnote task until it succeeds or fails
...
- treat Getnote and OSS URLs as temporary operational artifacts when they contain signed fields

...
- `metadata.name`: human-readable display name for the target skill
- `metadata.description`: purpose statement that describes what the skill is for, not how it works
